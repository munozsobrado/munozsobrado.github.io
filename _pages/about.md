...
Abstract (click to expand)  
    ...
    <p>
Charitable organizations are vital for funding public goods but often rely on costly fundraising efforts to finance their activities. This paper argues that fundraising through advertising turns charities into de facto competitors for funds in an otherwise rivalrous environment. I build a model where charities use informative advertising to attract individual donors. Competition leads to inefficient fundraising as charities incur excessive advertising costs, and the inefficiency increases as available funds increase. This paper highlights the implications of increased deductibility rates for charitable donations, such as intensified competition and potential impact on the quality of services provided by charities. I then estimate the model using data from the IRS, Kantar Media, and Charity Navigator. Increasing the deductibility rate leads to considerable increases in competition between charities. Findings suggest that fundraising elasticities account for significant endogenous leakage of donations into advertising, which implies that deductibility rates need to be adjusted downwards. 
    </p>
    </details><br>
