...
Abstract (click to expand)  
    ...
    <p>
Charitable organizations are vital for funding public goods, but they often rely on costly fundraising efforts to fund their activities. This paper argues that fundraising through advertising turns charities into de facto competitors for funds in an otherwise rivalrous environment.  I build a model where charities use informative advertising to attract individual donors. Competition leads to inefficient fundraising as charities incur excessive advertising costs, and the inefficiency increases as available funds increase. This paper highlights the implications of increased deductibility rates for charitable donations, such as intensified competition and potential impact on the quality of services provided by charities. I then use data from the IRS, Kantar Media, and Charity Navigator to estimate the model and find that increasing the deductibility rate leads to considerable increases in competition between charities. These findings underscore the need to consider trade-offs associated with tax incentives for charitable giving and consider competitive effects when designing policy aimed at promoting an impactful charitable sector.
    </p>
    </details><br>
<strong>Presentations:</strong> <font color="Crimson">  &#9992; <strong> [Upcoming]</strong> IIPF 2023 (Logan, Utah), EARIE 2023 (Rome)</font>, CEA 2023, ESA World Meeting 2022 (Boston), European ESA Meeting 2022 (Bologna), MannheimTaxation Conference 2022 <br><br>
